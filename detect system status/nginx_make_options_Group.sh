...
LINE_NUM=`grep  -n  "Nginx_Make_Group"   $ENV_PATH  |  awk -F:  '{print $1}'`

#在"Nginx_Make_Group"行之后添加一行

sed  -ie  "/Nginx_Make_Group/a \'Nginx_Make_Group\':\'$VALUE\'"   $ENV_PATH

#删除原来的"Nginx_Make_Group"行
